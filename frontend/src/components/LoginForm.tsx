      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="mb-4">
          ...
          <input
            ...
            id="username"
            name="username"
            className={`w-full p-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-teal-300 transition duration-300 ${
        ...
        <div className="mb-4 relative">
          ...
          {!(
            formik.values.username === "guest" &&
            formik.values.password === "11111"
          ) && (
            <button
              type="button"
              className="absolute right-3 top-3 text-teal-500 py-6 focus:outline-none text-sm"
